...
const { readFromFile, readAndAppend, writeToFile } = require('../helpers/helpers.js');
...
notes.delete('/:note_id', (req, res) => {
    ...
    readFromFile('./db/db.json')
        ...
        .then((json) => {
            // filter out notes without the id of the one being deleted
            const updatedData = json.filter((note) => note.id !== noteId);

            // write new list to db.json file
